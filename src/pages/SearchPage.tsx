          ...
          <div className="p-4">
            {cityNotFound ? (
              <div className="flex flex-col items-center justify-center">
                <p className="text-3xl text-gray-900 mt-5">
                  Let us help you find a restaurant!{" "}
                </p>
                <p className="text-lg text-gray-700 mt-5">
                  Can't find your city? No worries, new cities coming soon!{" "}
                </p>
              ...
              <>
                <div>
                  {restaurants.map((restaurant) => (
                    ...
                    >
                      <div className="flex items-center border border-navyblue border-2 rounded-lg p-4">
                        <img
                        ...
                        <div>
                          ...
                          <div className="flex mt-2">
                            <div className="rounded-full bg-blue-900 text-white px-2 py-1 text-xs mr-2">
                              {restaurant.foodStyle}
                            </div>
                            <div className="rounded-full bg-blue-900 text-white px-2 py-1 text-xs">
                              {restaurant.price}
                            </div>
                          </div>
